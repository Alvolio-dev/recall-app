...
export function FinalCta() {
  return (
    <section className="relative py-24 px-6 bg-zinc-900 rounded-t-[40px]">
      <div className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full bg-emerald-500/[0.08] blur-[150px] pointer-events-none" />
